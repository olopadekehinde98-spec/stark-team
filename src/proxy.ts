...
const PUBLIC_ROUTES = ['/login', '/signup', '/forgot-password', '/reset-password', '/setup', '/demo']
...
export const config = {
  matcher: ['/((?!_next/static|_next/image|favicon.ico|sw\\.js|workbox-.*|swe-worker-.*|icons/|.*\\.(?:svg|png|jpg|jpeg|gif|webp|ico|webmanifest)$).*)'],
}
